...
│   ├── 🌐 Domain: guestbook-tvu.duckdns.org
│   ├── 🔄 Auto-renewal: Yes
...
```
1. 🌐 User visits https://guestbook-tvu.duckdns.org/
...
- DNS record pointing `guestbook-tvu.duckdns.org` to your cluster
